...
public class MapFragment extends Fragment implements OnMapReadyCallback, GoogleMap.OnCameraChangeListener, GoogleMap.OnMarkerClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mListener.onListButtonClicked(mCenterLatLng.latitude, mCenterLatLng.longitude);
            }
        });
        return rootView;
    }
    ...
    private void sendSearchCurrentRegionRequest() {
        ...
        if(searchRadius >= MAX_RANGE) {
            Toast.makeText(mActivity, "Out of maximum range, please zoom out to search", Toast.LENGTH_LONG).show();
        } else {
            Dispatcher.instance().post(this, Constant.SEARCH_REQUEST, new Cmd.SearchCmd(mCenterLatLng, searchRadius, bounds));
        }
    }
    ...
    public interface MapfragmentListener{
        void onListButtonClicked(double lat, double lng);
